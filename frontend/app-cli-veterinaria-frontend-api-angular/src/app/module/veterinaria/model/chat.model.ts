...
/**
 * TODO: Description of {@code ChatViewModel}.
 *
 * @author Dyson Parra
...
export class ChatViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdChat: number;
    public intRemitente: number;
    public intReceptor: number;
     ...
     *
     */
    public newEntity(): ChatViewModel {
