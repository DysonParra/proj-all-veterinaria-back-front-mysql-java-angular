...
/**
 * TODO: Description of {@code ChatDetalleViewModel}.
 *
 * @author Dyson Parra
...
export class ChatDetalleViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdChatDetalle: number;
    public intIdPersona: number;
    @Temporal(TemporalType.TIMESTAMP)
    public dtUltima: string;
    public enmEscribiendo: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): ChatDetalleViewModel {
        return new ChatDetalleViewModel();
    }
