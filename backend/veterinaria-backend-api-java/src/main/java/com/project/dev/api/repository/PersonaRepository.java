...
/**
 * TODO: Definición de {@code PersonaRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface PersonaRepository extends JpaRepository<Persona, Long> {
     ...
     */
    public List<Persona> findByIntIdPersona(Long id);
    ...
    @Query("SELECT m FROM Persona m WHERE m.intIdPersona LIKE CONCAT('%', :strSearch, '%')")
    public List<Persona> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Persona m WHERE m.intIdPersona LIKE CONCAT('%', :strSearch, '%')")
    public Page<Persona> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
