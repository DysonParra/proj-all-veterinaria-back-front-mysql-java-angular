/*
 * @fileoverview    {ChatDetalleRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
import com.project.dev.api.service.ChatDetalleService;
import com.project.dev.api.web.rest.assembler.ChatDetalleRestAssembler;
...
/**
 * TODO: Definición de {@code ChatDetalleRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "ChatDetalle API")
public class ChatDetalleRest {

    private final Logger log = LoggerFactory.getLogger(ChatDetalleRest.class);
    private final ChatDetalleService entityService;
    private final ChatDetalleRestAssembler entityRestAssembler;
     ...
     */
    public ChatDetalleRest(ChatDetalleService entityService,
            ChatDetalleRestAssembler entityRestAssembler) {
    ...
    public CollectionModel<EntityModel<ChatDetalleDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<ChatDetalleDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(ChatDetalleRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<ChatDetalleDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/ChatDetalle/{query}/pages")
    public ResponseEntity<List<ChatDetalleDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ChatDetalle/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
