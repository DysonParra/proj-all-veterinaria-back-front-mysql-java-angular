...
public class MascotaRest {
    ...
    public ResponseEntity<List<MascotaDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<MascotaDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
