...
/**
 * TODO: Definición de {@code FotoRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface FotoRepository extends JpaRepository<Foto, Long> {
     ...
     */
    public List<Foto> findByIntIdFoto(Long id);
    ...
    @Query("SELECT m FROM Foto m WHERE m.intIdFoto LIKE CONCAT('%', :strSearch, '%')")
    public List<Foto> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Foto m WHERE m.intIdFoto LIKE CONCAT('%', :strSearch, '%')")
    public Page<Foto> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
