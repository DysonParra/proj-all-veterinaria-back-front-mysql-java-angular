...
public class ChatRest {
    ...
    public ResponseEntity<List<ChatDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<ChatDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
