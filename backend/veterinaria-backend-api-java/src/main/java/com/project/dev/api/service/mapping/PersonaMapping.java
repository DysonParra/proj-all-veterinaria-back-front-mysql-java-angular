/*
 * @fileoverview    {PersonaMapping} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code PersonaMapping}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface PersonaMapping extends GenericMapping<PersonaDTO, Persona> {
    ...
    @Mapping(source = "intIdPersona", target = "intIdPersona")
    @Override
    public PersonaDTO obtenerDto(Persona entity);
