/*
 * @fileoverview    {MascotaRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MascotaRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface MascotaRepository extends JpaRepository<Mascota, Long> {
     ...
     */
    public List<Mascota> findByIntIdMascota(Long id);
    ...
    @Query("SELECT m FROM Mascota m WHERE m.intIdMascota LIKE CONCAT('%', :strSearch, '%')")
    public List<Mascota> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Mascota m WHERE m.intIdMascota LIKE CONCAT('%', :strSearch, '%')")
    public Page<Mascota> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
