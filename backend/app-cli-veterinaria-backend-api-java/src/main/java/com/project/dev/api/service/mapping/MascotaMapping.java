...
public interface MascotaMapping extends GenericMapping<MascotaDTO, Mascota> {
    ...
    @Override
    public Mascota getEntity(MascotaDTO dto);
     ...
     */
    public default Mascota withId(String strId) {
        if (strId == null) {
            return null;
        }
        Mascota entity = new Mascota();
        entity.setIntIdMascota(Long.parseLong(strId));
        return entity;
    }
}
